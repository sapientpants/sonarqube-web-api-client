...
describe('SearchRulesBuilder', () => {
  ...
  let mockExecutor: Mock<Promise<SearchRulesResponse>, [SearchRulesRequest]>;

  beforeEach(() => {
    mockExecutor = vi.fn<Promise<SearchRulesResponse>, [SearchRulesRequest]>().mockResolvedValue({
      total: 0,
      p: 1,
      ps: 100,
      rules: [],
