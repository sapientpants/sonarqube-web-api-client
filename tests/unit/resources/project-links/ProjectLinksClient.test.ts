...
describe('ProjectLinksClient', () => {
  ...
  describe('search', () => {
    ...
    it('should search with both projectId and projectKey', async () => {
      const mockResponse = {
        links: [
          {
            id: '1',
  ...
  describe('searchDirect (deprecated)', () => {
    it('should search project links by project key', async () => {
      ...
      const result = await client.searchDirect({ projectKey: 'my-project' });
    ...
    it('should search project links by project ID', async () => {
      ...
      const result = await client.searchDirect({ projectId: 'AU-Tpxb--iU5OvuD2FLy' });

      expect(result).toEqual(mockResponse);
    });

    it('should throw error when neither projectId nor projectKey is provided', async () => {
      await expect(client.searchDirect({})).rejects.toThrow(
        'Either projectId or projectKey must be provided',
      );
    });
  ...
  describe('edge cases', () => {
    it('should handle empty links response', async () => {
      const mockResponse = {
        links: [],
      };
    ...
    it('should create link with both projectId and projectKey', async () => {
      const mockResponse = {
        link: {
          id: '1',
          name: 'Documentation',
